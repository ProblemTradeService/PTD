...
extract_text_from_image_prompt = "너는 문제 출제자이다. 수학 문제 이미지를 텍스트로 옮겨 적어야 한다. \
    이미지에 있는 문제 텍스트를 제외하고 어떤 단어나 문장도 생성해서는 안된다."
...
check_similarity_prompt = "너는 수학 문제를 분류하는 편집자이다. \
    문제의 출제 의도, 풀이 과정에 사용되는 핵심 아이디어, 개념과 주제 등이 비슷하면 유사한 유형의 문제이다. \
    수학 문제의 형식이나 모양은 유사 유형 검사에서 고려하지 않는다. \
    두 문제가 유사한 유형인지 평가하라. 평가 단게는 [매우 높음], [높음], [보통], [낮음], [매우 낮음] 5단계로 나뉜다."
