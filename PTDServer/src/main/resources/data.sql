...
<<<<<<< HEAD
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (1,3,50000,'kim','수열의 극한','매우 낮음','판매중');
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (2,2,100000,'choi','미분의 정의','높음','보유중');
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (3,5,70000,'Lee','적분의 정의','낮음','판매중');
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (4,4,20000,'kim','수열의 극한','높음','판매중');
...
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (2,2,100000,'kim','도함수의 활용','매우 낮음','판매중');
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (3,5,70000,'Lee','이차곡선','매우 높음','판매중');
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (4,4,20000,'kim','도함수의 활용','매우 낮음','판매중');
INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (5,3,30000,'dong','도함수의 활용','높음','판매중');
-- INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (6,1,20500,'mun','함수의 연속','보통','판매중');
-- INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (7,2,20400,'jung','미적분의 기본정리','매우 낮음','판매중');
-- INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (8,4,26000,'kwang','삼각함수의 연속','높음','판매중');
-- INSERT INTO Problem (id,level,price,owner,category,plaglevel, status) VALUES (9,5,50000,'do','수열의 극한','매우 높음','판매중');
...
<<<<<<< HEAD
INSERT INTO User_Balance (id, username, balance) VALUES (4,'dong',250000);
...
INSERT INTO Problem_Similar_List (pid1, pid2, similarity, plagiarize) VALUES (4,1,'높음','높음');
